...
@view
func get_pending_governance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ) -> (pending_governance : felt):
    let (pending_governance) = pending_governance_storage.read()
...
func constructor{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    governance_storage.write(account)
    set_governance_event.emit(account)
    return()
end
